          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url().'assets/AdminLTE-2.3.0/dist/img/'.$this->session->userdata('user_id').'.'.'jpg' ?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $this->session->userdata('identity')?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo base_url().'assets/AdminLTE-2.3.0/dist/img/'.$this->session->userdata('user_id').'.'.'jpg' ?>" class="img-circle" alt="User Image">
                    <p>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url() ?>index.php/User"><i class="fa fa-circle-o"></i>View</a></li>
               <li><a href="<?php echo base_url() ?>index.php/auth/create_user"><i class="fa fa-circle-o"></i>Create User</a></li>
               <li><a href="<?php echo base_url() ?>index.php/auth/create_group"><i class="fa fa-circle-o"></i>Create Group</a></li>
              </ul>
            </li>
